...
| **Detection and Reflection Artifact Deep Learning Dataset** | [Photoacoustic Source Detection and Reflection Artifact Removal Enabled by Deep Learning](https://ieeexplore.ieee.org/document/8345287) | 2018.04.23 | Simulations initially contained one source and one artifact with various medium sound speeds and 2D target locations. | [Download](https://ieee-dataport.org/open-access/photoacoustic-source-detection-and-reflection-artifact-deep-learning-dataset) |
