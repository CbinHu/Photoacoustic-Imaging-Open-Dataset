# 📝 PAID: Photoacoustic Imaging Open Datasets 光声成像公开数据集
...
| **OR-PAM** | [Convolutional autoencoder-based reconstruction of vascular structures in photoacoustic images](https://www.scopus.com/pages/publications/85090386037) | 2020 | PAM | The noisy and Gabor filtered sub-images, those contain the patterns of different vascular structures. | [Download](https://osf.io/9u3kt/?view_only=36f8fa0e4c884aad80b371b83a993d68) |
| **Detection and Reflection Artifact Deep Learning Dataset** | [Photoacoustic Source Detection and Reflection Artifact Removal Enabled by Deep Learning](https://ieeexplore.ieee.org/document/8345287) | 2018.04.23 | PACT | Simulations initially contained one source and one artifact with various medium sound speeds and 2D target locations. | [Download](https://ieee-dataport.org/open-access/photoacoustic-source-detection-and-reflection-artifact-deep-learning-dataset) |
| **OADAT** | [OADAT: Experimental and Synthetic Clinical Optoacoustic Data for Standardized Image Processing](https://arxiv.org/abs/2206.08612#:~:text=In%20this%20paper%2C%20we%20provide%20both%20experimental%20and,with%20different%20experimental%20parameters%20and%20tomographic%20acquisition%20geometries.) | 2023.02.24 | PACT | Forearm dataset. | [Download](hdl.handle.net/20.500.11850/551512) |
...
"In PAI, currently reported training data sets have been listed in Table 1. Most of them contain MRI and x-ray CT images that can be transformed into PA images by simulation. Detailed information about the construction of numerical phantoms for PAI can be found in [Ref.](https://doi.org/10.1117/1.JBO.22.4.041015). DL is also used for segmenting different tissue types when unlabeled data from other imaging modalities are applied for simulating [PA raw data](https://doi.org/10.1109/EMBC44109.2020.9176298). In addition, to improve preclinical image quality and accelerate PAI’s clinical translations, the international photoacoustic standardization consortium is pushing forward an open-access plat form for standardized [PA reference data](https://doi.org/10.1117/12.2506044)."
